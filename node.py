...
from utils import print_fn, GPU_FLOPs
...
class Node(object):
    def __init__(self, id, num_gpus=8, num_cpus=96, mem=720,
                 job_runn_list=None, gpu_type=0, gpu_size=40, gpu_FLOPs=None):
        self.id = id
        ...
        self.gpu_size = gpu_size # GB
        self.gpu_FLOPs = gpu_FLOPs if gpu_FLOPs is not None else GPU_FLOPs.get(gpu_type, 1*(10**12))
